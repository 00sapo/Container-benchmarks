...
docker run -it -v $(pwd):/home/user $docker_id sh /home/user/benchmark.sh > results/podman.txt
apptainer run ./fedora.sif > results/apptainer.txt
devbox run ./benchmark.sh > results/devbox.tx
